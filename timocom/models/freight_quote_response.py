...
T = TypeVar("T", bound="FreightQuoteResponse")
...
class FreightQuoteResponse:
    ...
    Attributes:
        ...
        payload (FreightQuote | Unset):
    """

    meta: FreightExchangeResponseMeta | Unset = UNSET
    payload: FreightQuote | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = FreightQuote.from_dict(_payload)

        freight_quote_response = cls(
            meta=meta,
            payload=payload,
        )

        freight_quote_response.additional_properties = d
        return freight_quote_response
