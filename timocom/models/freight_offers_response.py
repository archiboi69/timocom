...
T = TypeVar("T", bound="FreightOffersResponse")


@_attrs_define
class FreightOffersResponse:
    """
    Attributes:
        meta (FreightExchangeResponseMeta | Unset):
        payload (list[FreightOffer] | Unset):
    """

    meta: FreightExchangeResponseMeta | Unset = UNSET
    payload: list[FreightOffer] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _payload is not UNSET:
            ...
            for payload_item_data in _payload:
                payload_item = FreightOffer.from_dict(payload_item_data)

                payload.append(payload_item)

        freight_offers_response = cls(
            meta=meta,
            payload=payload,
        )

        freight_offers_response.additional_properties = d
        return freight_offers_response
