...
T = TypeVar("T", bound="TonRange")


@_attrs_define
class TonRange:
    """Filter criteria that can be defined to find offers which weight is within the defined range.

    Attributes:
        inclusive_minimum (float | Unset): The amount describes unit and subunit of weight in tons in a single value,
        ...
        inclusive_maximum (float | Unset): The amount describes unit and subunit of weight in tons in a single value,
            where the integer part (digits before the decimal point) is for the major unit and fractional part (digits after
            the decimal point) is for the minor unit. Example: 5.55.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ton_range.additional_properties = d
        return ton_range
