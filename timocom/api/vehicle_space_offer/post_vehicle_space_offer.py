...
def _get_kwargs(
    *,
    body: VehicleSpaceOffer | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/my-vehicle-space-offers",
    }
...
def sync_detailed(
    *,
    ...
    """Publish Vehicle Space Offer

     Post new Vehicle Space Offer.

    Args:
        body (VehicleSpaceOffer | Unset): A vehicle space offer that is published within the
            freight exchange indicates available vehicle space. It contains information related to
            available vehicle.
