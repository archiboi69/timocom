...
from ...models.vehicle_space_offer_response import VehicleSpaceOfferResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/my-vehicle-space-offers/{public_offer_id}".format(
...
) -> Problem | VehicleSpaceOfferResponse | None:
    if response.status_code == 200:
        response_200 = VehicleSpaceOfferResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Problem | VehicleSpaceOfferResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Lookup Your Own Vehicle Space Offer

     Get your own Vehicle Space Offer by its ID.
...
def sync(
    ...
    *,
    ...
    Returns:
        Problem | VehicleSpaceOfferResponse
    """
