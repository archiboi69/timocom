...
def _get_kwargs(
    ...
    *,
    timocom_id: int,
    accepted_freight_quote_id: str | Unset = UNSET,
) -> dict[str, Any]:
    ...
    params["accepted_freight_quote_id"] = accepted_freight_quote_id

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/my-freight-offers/{public_offer_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        accepted_freight_quote_id (str | Unset): Alphanumeric unique ID which is used to identify
            an entity (freight offer, vehicle space offer, freight quote) in the TIMOCOM system. Will
            be generated on TIMOCOM side, only. Example: NdKoYeUDQheRB14EeyJzTg.
    ...
    kwargs = _get_kwargs(
        ...
        accepted_freight_quote_id=accepted_freight_quote_id,
    )
