...
from ...models.freight_quote_response import FreightQuoteResponse
...
) -> FreightQuoteResponse | Problem | None:
    if response.status_code == 200:
        response_200 = FreightQuoteResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[FreightQuoteResponse | Problem]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Lookup Freight Quote

     Get a Freight Quote by its ID.
